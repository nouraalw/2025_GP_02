...
<div class="certificate-list">
    ...
    <?php
    $certificates = json_decode($row['certificate_file'], true); // Decode JSON
    if (!empty($certificates)) {
        foreach ($certificates as $certificate) {
            echo '<a href="' . $certificate . '" target="_blank" class="Certificate-btn">View Certificate</a><br>';
        }
    } else {
