...
document.addEventListener("DOMContentLoaded", function () {
 ...
 <footer>
        ...
        <div class="footer-links">
         ...
         <div id="contact" style="color:">
        <p>Phone Number: 05xxxxxxxxx</p>
        <p>Email: aspira@gmail.com</p>
         
        <img src="images/twitter.png" class="icon" alt="X" width="25" height="35">
        <img src="images/instagram.png" class="icon" alt="Instagram" width="35" height="35">
