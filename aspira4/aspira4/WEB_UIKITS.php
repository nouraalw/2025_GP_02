...
$session_end_time = $session_start_time + (45 * 60); // 45 mins duration
$current_time = time();
...
window.onload = function () {
    const isGroup = <?php echo $isGroup ? 'true' : 'false'; ?>; 
    const roomID = "<?php echo $roomID; ?>";
    const userID = Math.floor(Math.random() * 10000) + "";
    const userName = "user" + userID;
    const AppID = 516882468;
    const ServerSecret = "26f68ef98b804b9b64fc2ef1883beef9";
            ...
            fetch('update_session_status.php?roomID=' + roomID)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (role === "mentor") {
                            if (isGroup) {
                                window.location.href = "mentor_past_group_sessions.php";
                            } else {
                        ...
                        // ✅ Mentee redirection
                            ...
                            if (isGroup) {
                                window.location.href = "mentee_GroupPast_session.php";
                            } else {
