  ...
  <div class="modal-content">
    ...
    <form id="summaryForm" action="save_summary.php" method="POST">
      ...
      <div style="display:flex; justify-content:flex-end; gap:10px;">
        <button type="button" id="editBtn" style="display:none; background:#4b398e; color:#fff; border:none; padding:8px 20px; border-radius:6px; cursor:pointer;">✏️ Edit</button>
